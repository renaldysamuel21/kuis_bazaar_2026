...
def make_icon(size: int, filename: str) -> None:
    scale = size / 512
    image = Image.new("RGB", (size, size), "#f7c3d5")
    draw = ImageDraw.Draw(image)

    def s(value):
        return int(round(value * scale))

    rounded(draw, (s(30), s(30), s(482), s(482)), s(112), "#fff6f8", "#ffffff", s(10))
    draw.ellipse((s(92), s(350), s(420), s(430)), fill="#d9a6b8")
    draw.ellipse((s(126), s(104), s(386), s(386)), fill="#e96592", outline="#fff2f6", width=s(14))
    draw.polygon([(s(151), s(144)), (s(172), s(70)), (s(228), s(134))], fill="#e96592")
    draw.polygon([(s(361), s(144)), (s(340), s(70)), (s(284), s(134))], fill="#e96592")
    ...
    draw.ellipse((s(153), s(286), s(198), s(306)), fill="#cc4e78")
    draw.ellipse((s(314), s(286), s(359), s(306)), fill="#cc4e78")
